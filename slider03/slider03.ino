///////////////////////////////////////////
//               Cambios v3              //
// - Quitar tiempo de disparo            //
// - Añadir menu principal               //
// - Añadir 500ms entre focus  //
///////////////////////////////////////////
...
//unsigned int stepsPerRev = 4076;  // pasos para una vuelta completa
//unsigned int motorSpeed = 1200;   //variable para fijar la velocidad del motor
const unsigned int  offsetDis      = 1000;  // tiempo fijo que espera antes de disparar en ms
const unsigned int  duracionDis    = 500;   // tiempo que emplea en disparar en ms
const unsigned int  tiempoFocusDis = 500;    // tiempo entre focus y disparo
unsigned int        stepCounter    = 0;     // contador para los pasos de motor
